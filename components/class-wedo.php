...
extends WC_Shipping_Method{public function __construct($instance_id=0){
  ...
  $this->method_title='WE|DO';$this->method_description=' Zákazníci si na mapě snadno a pohodlně vyberou nejbližší výdejní místo WE|DO ULOŽENKA nebo WE|DO BOX.';
...
public function init_form_fields(){
  $this->form_fields=array('op1'=>array('title'=>'WE|DO Uloženka','label'=>'Zobrazení se ve widgetu výdejní místa WE|DO Uloženky','type'=>'checkbox','default'=>'yes',),'op2'=>array('title'=>'WE|DO Boxy','label'=>'Zobrazení se ve widgetu WE|DO Boxy','type'=>'checkbox','default'=>'yes',));
}

public function init_instance_form_fields(){
  $this->instance_form_fields=array('wedo_nazev'=>array('title'=>'Název','type'=>'text','description'=>'Název pro zobrazení v eshopu.','default'=>'WE|DO','css'=>'width: 300px;'),'wedo_zakladni-cena'=>array('title'=>'Základní cena','type'=>'price','description'=>'Pokud nebude cena vyplněna, tak bude nulová.','default'=>'','css'=>'width: 100px;','placeholder'=>wc_format_localized_price(0)),);
}}
